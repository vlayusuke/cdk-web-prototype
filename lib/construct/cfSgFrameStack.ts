...
export class cfSgFrameStack extends Construct {
    ...
    constructor(scope: Construct, id: string, props: commonProps) {
        ...
        cdk.Tags.of(this.albSecurityGroupFrame).add('Name', `${props.projectName}-${props.envName}-sg-alb`);
        ...
        cdk.Tags.of(this.bastionSecurityGroupFrame).add('Name', `${props.projectName}-${props.envName}-sg-bastion`);
        ...
        cdk.Tags.of(this.batchSecurityGroupFrame).add('Name', `${props.projectName}-${props.envName}-sg-batch`);
        ...
        cdk.Tags.of(this.ecsSecurityGroupFrame).add('Name', `${props.projectName}-${props.envName}-sg-ecs`);
        ...
        cdk.Tags.of(this.auroraSecurityGroupFrame).add('Name', `${props.projectName}-${props.envName}-sg-aurora`);
        ...
        cdk.Tags.of(this.lambdaSecurityGroupFrame).add('Name', `${props.projectName}-${props.envName}-sg-lambda`);
        ...
        cdk.Tags.of(this.vpcEndPointS3SecurityGroupFrame).add('Name', `${props.projectName}-${props.envName}-sg-vpc-endpoint-s3`);
        ...
        cdk.Tags.of(this.vpcEndPointECRSecurityGroupFrame).add('Name', `${props.projectName}-${props.envName}-sg-vpc-endpoint-ecr`);
        ...
        cdk.Tags.of(this.vpcEndPointSSMSecurityGroupFrame).add('Name', `${props.projectName}-${props.envName}-sg-vpc-endpoint-ssm`);
        ...
        cdk.Tags.of(this.vpcEndPointKMSSecurityGroupFrame).add('Name', `${props.projectName}-${props.envName}-sg-vpc-endpoint-kms`);
        ...
        cdk.Tags.of(this.vpcEndPointCloudWatchLogsSecurityGroupFrame).add('Name', `${props.projectName}-${props.envName}-sg-vpc-endpoint-cloudwatch-logs`);
